...
mixin _$CheckoutStore on _CheckoutStore, Store {
  ...
  void onShipToDifferentAddress() {
    final _$actionInfo = _$_CheckoutStoreActionController.startAction(name: '_CheckoutStore.onShipToDifferentAddress');
    try {
      return super.onShipToDifferentAddress();
    } finally {
      _$_CheckoutStoreActionController.endAction(_$actionInfo);
    }
  }
